...
public interface EmployeeRepository<T extends Employee>
     ...
     */
    @Query("SELECT AVG(e.salary) FROM #{#entityName} e WHERE e.terminationDate IS NULL AND e.deletedAt IS NULL")
     ...
     */
    @Query("SELECT e.department, AVG(e.salary) FROM #{#entityName} e WHERE e.terminationDate IS NULL AND e.deletedAt IS NULL GROUP BY e.department")
     ...
     */
    @Query("SELECT e FROM #{#entityName} e WHERE e.terminationDate IS NULL AND e.deletedAt IS NULL ORDER BY e.salary DESC")
     ...
     */
    @Query("SELECT e FROM #{#entityName} e WHERE e.terminationDate IS NULL AND e.deletedAt IS NULL ORDER BY e.salary ASC")
